...
from models import storage, City, Amenity
...
def hbnb_filters():
	...
	return render_template('10-hbnb_filters.html', states=sent, amenities=amenities)
...
def hbnb():
	...
	for state in states:
		...
		sent.append(tempdict)
	amenities = list(storage.all(Amenity).values())
	return render_template('100-hbnb.html', states=sent, amenities=amenities)
